...
dap.adapters = {
   codelldb = {
      ...
      executable = {
        -- command = 'codelldb',
        command = '/nix/store/7hqki406zw8mib4i6j4g21133hqjzlfk-vscode-extension-vadimcn-vscode-lldb-1.10.0/share/vscode/extensions/vadimcn.vscode-lldb/adapter/codelldb',
        args = { "--port", "13000" },
        detached = false,
      }
    },

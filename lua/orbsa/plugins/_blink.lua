-- Custom label description for LSP kinds
...
-- Copilot integration (run this before setup)
...
require("blink.cmp").setup({
  sources = {
    default = function()
      ...
      return { "copilot", "lsp", "snippets", "path", "buffer", "emoji" }
    end,
    providers = {
      buffer = {
        name = "buffer",
  ...
  snippets = {
    expand = function(snippet)
      require("luasnip").lsp_expand(snippet.body or snippet)
    end,
  },
  ...
  appearance = {
    ...
    kind_icons = kind_icons,       -- optional: your kind icons
    source_icons = menu_icons,     -- optional: your source icons
  },
